...
/***/ function(module, exports, __webpack_require__) {
	...
	function getData() {
		var data = [{id: 1, text: 'ตันโอชิ'}];
		for(var i=2;i<=28;i++)
			data.push({id: i, text: i+' โอชิ'});
		data.push({id: 29, text: 'DD'})
	  	return data
	}

	var el2 = document.getElementById('select2')
	
	var select2 = new Select(el2, {
	  data: getData2()
	})
	select2.value(0)
	...
	function getData2() {
	  	return [{id: 0, text: 'ได้โอชิสักคน'}, {id: 1, text: 'ได้โอชิครบ'}]
	}
